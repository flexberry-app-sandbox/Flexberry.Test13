...
namespace IIS.Test13
{
    ...
    public class Улица : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Test13.Город fГород;
        ...
        [PropertyStorage(new string[] {
                "Город"})]
        [NotNull()]
        public virtual IIS.Test13.Город Город
        {
            get
            {
                ...
                IIS.Test13.Город result = this.fГород;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УлицаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаE", typeof(IIS.Test13.Улица));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УлицаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УлицаL", typeof(IIS.Test13.Улица));
                }
            }
        }
    }
